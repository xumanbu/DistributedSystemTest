...
public class JdbcWechatAppConfigStore implements WechatAppConfigStore {
    ...
    public JdbcWechatAppConfigStore(DataSource dataSource) {
    ...
    public WechatAppConfig getWechatAppConfigByAppId(String appId) {
        return mJdbcTemplate.queryForObject(APP_CONFIG_SELECT_BY_APP_ID_STATEMENT,
                new WechatAppConfigRowMapper(), appId);
    }

    @Override
    public WechatAppConfig getWechatAppConfig(String id) {
        return mJdbcTemplate.queryForObject(APP_CONFIG_SELECT_BY_ID_STATEMENT,
                new WechatAppConfigRowMapper(), id);
    }


    private final class WechatAppConfigRowMapper implements RowMapper<WechatAppConfig> {
