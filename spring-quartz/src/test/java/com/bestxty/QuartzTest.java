...
import com.bestxty.ds.quartz.QuartzJobFactory;
import com.bestxty.ds.quartz.QuartzJobFactoryDisallowConcurrentExecution;
import com.bestxty.ds.quartz.ScheduleJob;
...
@ContextConfiguration({"classpath:spring-quartz-test.xml"})
public class QuartzTest extends AbstractJUnit4SpringContextTests {
    ...
    public void testQuartzTask() throws SchedulerException, IOException {
        ...
        List<ScheduleJob> scheduleJobs = getAllJob();
